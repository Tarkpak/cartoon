...
提示词中心当前保留以下 12 个模板（按阶段）：

- 解析：`script_episode_plan`、`script_parsing`、`script_parsing_short_drama`、`script_parsing_episode_drama_context`、`prompt_translation_system`、`prompt_translation_user`
- 资产：`character_sheet`、`character_regeneration`、`environment_reference_generation`、`prop_asset_generation`、`scene_description_refinement`
